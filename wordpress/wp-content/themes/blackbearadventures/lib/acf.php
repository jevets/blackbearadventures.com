...
if(function_exists("register_field_group"))
{
  register_field_group(array (
    ...
    'fields' => array (
      array (
        'key' => 'field_52dbf0a50260c',
        'label' => 'Trip Dates',
        'name' => 'trip_dates',
        'type' => 'repeater',
        'sub_fields' => array (
          array (
            'key' => 'field_52dbf0b80260d',
            'label' => 'Year',
            'name' => 'year',
            'type' => 'text',
            'instructions' => 'i.e. 2014',
            'column_width' => '',
            'default_value' => '',
            'placeholder' => '',
            'prepend' => '',
          ...
          array (
            ...
            'sub_fields' => array (
              ...
              array (
                'key' => 'field_52dbf10202610',
                'label' => 'Date Range',
                'name' => 'date_range',
                'type' => 'text',
                'instructions' => 'i.e. June 13-22',
                'column_width' => '',
                'default_value' => '',
                'placeholder' => '',
                'prepend' => '',
