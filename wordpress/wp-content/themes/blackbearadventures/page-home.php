    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-sm-4">
          ...
          <p>We carefully design each tour and select each road to ensure the finest rider experience available... remember at Black Bear Adventures "It <em>IS</em> About the Bike”!</p>
          <p class="lead">Are you ready to accept the Challenge?</p>
        </div><!-- /.col-lg-4 -->
        <div class="col-sm-4">
      ...
      <div class="row featurette">
        <div class="col-sm-7">
          <h2 class="featurette-heading"><a href="/blue-ridge-parkway/">Blue Ridge Parkway <span class="text-muted"> Bicycle Tour</span></a></h2>
